...
export default function BoardPage() {
  ...
  return <><BoardPageUI data={data} handleMoveListPage={handleMoveListPage} 
                      handleMoveUpdate={handleMoveUpdate} handleLike={handleLike} handleDislike={handleDislike}
                      handleChangeInput={handleChangeInput}></BoardPageUI>
                      <Comment></Comment>
                      </>
}