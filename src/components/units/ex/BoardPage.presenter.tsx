...
import {Title, Image, MainWrapper, Content, Video, SecondWrarper, ThirdWarrper, Container,
        Fourth, FourWrapper, Box, Disbox, FfWrapper, Name, Date, NdWrapper, InmWrapper,
        InmiWrapper, Iwrapper, InWrapper, DivideLine, Navi, Navi2, NaveWrapper, ListPage,
        Retouch, LineWrapper, Straight, CommentBox, MaindWrapper, CommentWrapper, WritherBox,
        PasswordBox, BottomWrapper, ContentView, ContentWrite, TextComment, ContentWrapper,
        CommentFullWrapper, Star, StarWrapper} from './BoardPage.style';

export default function BoardPageUI({data, handleMoveListPage, handleMoveUpdate, handleLike, handleDislike, handleChangeInput}) {
...
//   console.log(data?.fetchBoard?.writer,"asdhasjkdhasjkdhjk")
    return (
      <MaindWrapper>
            ...
            <MainWrapper>
                <NaveWrapper>
                    <Navi>서울특별시 영등포구 양산로 200<Navi2>(영등포동5가, 영등포시장역) 영등포 타임스퀘어 2층</Navi2></Navi>
                </NaveWrapper>
                <InmiWrapper>
                <InmWrapper>
                    <InWrapper>
                    ...
                    <NdWrapper>
                        ...
                        <Date>{!data ? <></> : data.fetchBoard?.createdAt.slice(0,10)}</Date>
                    </NdWrapper>
                    </InWrapper>
                    <Iwrapper>
